...
from claude_agents.agents.security_scanner import SecurityScannerAgent, SecurityConfig
...
class TestSecurityScannerAgent:
    ...
    @pytest.mark.asyncio
    @patch('claude_agents.agents.security_scanner.SecurityScannerAgent._run_security_scan')
