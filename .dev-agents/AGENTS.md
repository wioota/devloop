...
**Amp integration instructions for dev-agents**
...
This will:
- Install Claude Agents to `~/.dev-agents`
- Set up Python virtual environment
- Add `dev-agents` and `ca` to your PATH
...
For even deeper integration, dev-agents could provide:
